...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
internal protocol AudioDataSourceDelegate : class
{
    func didReceiveAudioData(unsafePointerInt16AudioData : UnsafePointer<Int16>, count audioDataCount : UInt32) -> Void;
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
internal class AudioDataSource : NSObject, AVCaptureAudioDataOutputSampleBufferDelegate
{
    // NSObject
        ...
        fromConnection connection : AVCaptureConnection!)
    {
        ...
        for audioBuffer in unsafeMutableAudioBufferListPointer
        {
            ...
            delegate?.didReceiveAudioData(unsafePointerInt16AudioData, count:audioDataCount);
